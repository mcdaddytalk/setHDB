...
public class Metrics {
     ...
     */
    public Metrics() {
        if (SetHDB.getInstance() == null) {
            throw new IllegalArgumentException("Plugin cannot be null!");
        }
        this.plugin = SetHDB.getInstance();
        if (ConfigHandler.getConfig(false).getFile("config.yml").getBoolean("General.MetricsLogging")) {
    ...
    private void startSubmitting() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                Bukkit.getScheduler().scheduleSyncDelayedTask(SetHDB.getInstance(), new Runnable() {
                    @Override
                    public void run() {
                        submitData();
                    }
